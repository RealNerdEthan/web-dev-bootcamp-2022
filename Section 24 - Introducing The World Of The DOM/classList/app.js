...
//Lets set a class attribute
h2.setAttribute("class", "purple");

//Using classList, we can use the .add method to add more than 1 class to an Element (.remove would remove)
h2.classList.add("border")

//And we can also toggle adding/removing attribute properties
